    ...
    <>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img
              src="/ark-icon.jpg"
              alt="Ark"
              className="w-9 h-9 rounded-ark shrink-0 ring-1 ring-[oklch(from_var(--ark-warm)_l_c_h_/_0.25)] shadow-[0_0_14px_0_var(--ark-warm-bg)]"
            />
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 ${collapsed ? "lg:justify-center lg:px-2" : "px-3"} py-2.5 rounded-ark text-sm font-medium transition-all duration-ark-fast ${
                isActive
                  ? "bg-ark-primary-bg text-ark-primary border border-[oklch(from_var(--ark-primary)_l_c_h_/_0.3)]"
                  : "text-ark-text-muted hover:text-ark-text-bright hover:bg-[oklch(from_var(--ark-text-bright)_l_c_h_/_0.05)] border border-transparent"
              }`
            }
          >
      ...
      <div className="hidden lg:flex border-t border-ark-border p-2 justify-center">
        <button
          ...
          className="p-2 rounded-ark text-ark-text-muted hover:text-ark-text-bright hover:bg-[oklch(from_var(--ark-text-bright)_l_c_h_/_0.05)] transition-colors"
