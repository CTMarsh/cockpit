...
function toneClasses(tone: Tone) {
  return tone === "warm"
    ? { fg: "text-ark-warm", bg: "bg-ark-warm-bg", border: "hover:border-[oklch(from_var(--ark-warm)_l_c_h_/_0.4)]" }
    : { fg: "text-ark-primary", bg: "bg-ark-primary-bg", border: "hover:border-[oklch(from_var(--ark-primary)_l_c_h_/_0.4)]" };
}
